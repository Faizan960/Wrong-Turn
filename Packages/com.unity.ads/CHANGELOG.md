...
### **iOS**
- Reduced crashes on devices running iOS versions earlier than 18.
...
### **iOS**
- Added new beta public API for Swift and Objective-C. Refer to the Beta privacy API update guide for details on the updated Unity Ads privacy APIs.
...
## [4.16.4] - 2025-11-14
### **Android**
- Fixed out-of-memory crashes that occurred on low-memory devices to improve app stability.
